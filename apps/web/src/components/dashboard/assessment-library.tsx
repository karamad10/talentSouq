...
const inputClass =
  "h-9 w-full rounded-ts-md border border-ts-field bg-ts-surface px-3 text-[13px] text-ts-ink outline-none transition-colors placeholder:text-ts-muted focus:border-ts-primary";
  ...
  return (
    <SectionPanel
      ...
      action={
        ...
        >
          <form className="flex flex-col gap-3" onSubmit={createAssessment}>
          ...
          <li key={item.name} className={index > 0 ? "border-t border-ts-line" : undefined}>
            <div className="flex flex-wrap items-center gap-4 py-3">
              <div className="min-w-0 flex-1">
                <strong className="flex items-center gap-2 text-sm font-semibold text-ts-ink">
