...
export default async function InvitePage({ params }: { params: Promise<{ token: string }> }) {
  const [{ token }, cookieStore, user] = await Promise.all([params, cookies(), getSessionUser()]);
